...
def trans():
    ...
    print('原文：' + '\n' + old_words)
    try:
        th = threading.Thread(target=translate,args = (old_words,))
        th.setDaemon(True)
        th.start()
...
#组件Text
text1 = Text(frame2,width = 51,height = 20,font = ('宋体',12))
text2 = Text(frame4,width = 51,height = 20,fg = 'blue',font = ('宋体',12))
